# **Github for NeuroStartUp**
Разработанный проект направлен на то, чтобы в полной мере продемонстрировать команде NeuroStartUp основные преимущества работы с сервисом контроля версий [GitHub.com](https://github.com/)

К ним относятся:
* хранение историй изменений
* видимость и авторство каждого изменения
* "резервная копия" проекта
## **Начало работы**
Для того, чтобы получить копию этого проекта и запустить её на локальном компьютере, необходимо выполнить следующие действия:
1. Зарегистрировать на сайте [GitHub.com](https://github.com/)
1. Перейти по ссылке, на которой расположен репозиторий проекта: [Repository](https://github.com/petrova-ag/NeuroStartUp)
1. Нажать на кнопку "Clone or Download", расположенную с правой стороны экрана
![ScreenShot](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/download.jpg?raw=true)
1. После этого выбрать опцию "Download ZIP"
![Screenshot](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/downloadzip.jpg?raw=true)
1. В результате, архив с файлами проекта будет загружен на локальный компьютер
### **Предварительная подготовка**
Для возможности дальнейшей работы с загруженными файлами проекта, а также для контроля версий вам понадобится совершить несколько дополнительных установок на ваш ПК:
* Git - одна из самых популярных систем контроля версий, позволит вам фиксировать изменения, происходящие в вашем проекте и осуществлять синхронизацию с удаленной резервной копией ([Git download](https://git-scm.com/download/win))
* Браузер - понадобится для доступа к сайту GitHub, который используется для создания резервных копий ([Google Chrome download](https://windows-chrome.ru/?yclid=538682577374436522))
* Visual Studio Code - программа для более удобной работы с проектом ([Visual Studio Code download](https://code.visualstudio.com/))
### **Установка и запуск**
Теперь подробней расскажем о установке и запуске системы контроля версий Git. 
Для установки необходимо:
1. Скачать установочный [файл](https://git-scm.com/download/win)
1. Запустить скачанный exe-файл и дождаться появления экрана установки
1. Прочитать условия лицензии, после чего нажать кнопку "Next"
![Licence](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git1.jpg?raw=true)
1. Выбрать путь для установки Git (точное местоположение программы на вашем компьютере) и нажмите кнопку "Next"
1. Выберите необходимые установочные компоненты и нажмите кнопку "Next"
![Components](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git2.jpg?raw=true)
1. Введите желаемое имя пункта меню в Пуск или оставьте значение по умолчанию "Git", после чего нажмите кнопку "Next"
1. Выберите предпочтительный редактор для использования из выпадающего списка и нажмите кнопку "Next"
![Editor](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git3.jpg?raw=true)
1. Выберите, добавлять ли Git в переменную окружения PATH (набор путей файловой системы, в которой ищутся запускаемые файлы), кликните на желаемый вариант и нажмите кнопку "Next"
![PATH](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/gitPATH.jpg?raw=true)
1. Выберите библиотеку, которая будет использоваться для HTTPS-соединений и нажмите кнопку "Next"
![HTTPS](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/gitHTTPS.jpg?raw=true)
1. Выберите желаемую опцию с символами окончания строки и нажмите кнопку "Next"
![EndSymbols](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git7.jpg?raw=true)
1. Выберите, какой терминал (командную строку) вы будете использовать в Git и нажмите кнопку "Next"
![Terminal](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git8.jpg?raw=true)
1. Выберите предлагаемые дополнительные опции и нажмите кнопку "Next"
![ExtraOptions](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git9.jpg?raw=true)
1. При желании, выберите установку экспериментальных опций и и нажмите кнопку "Next"
1. Дождитесь завершения установки и нажмите кнопку "Finish"
![Downloading](https://github.com/petrova-ag/NeuroStartUp/blob/master/images/git10.jpg?raw=true)
### **Лицензия**
...
1. Отказ от гарантий или ограничения ответственности иначе, чем в разделах 15 и 16 Данной лицензии; или
1. Требование сохранения указанных действительных юридических уведомлений или авторства в этом материале, или в Соответствующих Правовых Уведомлениях, отображаемых произведением, их содержащим; или
1. Запрет на искажение происхождения этого материала, либо требование к модифицированным версиям такого материала содержать пометку в надлежащей форме о том, что материал отличается от оригинальной версии; или
1. Ограничение на использование в рекламных целях имен владельцев лицензии или авторов материала; или
...
1. Требование компенсации владельцам лицензии и авторам этого материала кем-либо, кто передает материал (или его модифицированные версии) с договорным принятием ответственности получателя для любой ответственности, которую данное договорное принятие непосредственно налагает на владельцев лицензии и авторов.
